<?php
//calendar to include between head tags
// include("config.php");
?>
<script type="text/javascript">
//<![CDATA[
// {{{ this is a VIM (text editor) text fold
...
calendarColors['bgColor'] = '#dfdfdf';
calendarColors['borderColor'] = '#999999';
calendarColors['headerBgColor'] = '#666666';
calendarColors['headerColor'] = '#ffffff';
calendarColors['dateBgColor'] = '#cccccc';
...
//var calendarFormat depend de config.php
<?php
if ($date_format=='fr')
...
function getCalendar(in_dateField) 
{
    if (calendarWindow && !calendarWindow.closed) {
        alert('Fenêtre de calendrier déjà ouverte. Tentative de reprise de contrôle...');
        try {
