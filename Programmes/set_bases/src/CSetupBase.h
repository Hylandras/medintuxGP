...
class CSetupBase
{
 ...
 public:
  ...
  int           CreationBase(QSqlDatabase* mysqlbase, QString &nameBase, QString *errMess =0, int *errNum =0, const QString &driver="QMYSQL3", const QString &user="root", const QString &passWord="", const QString &hostName="localhost", const QString &port="3306");
  int           BackUpBase(            QString &nomBase,
                                       QString backName,
