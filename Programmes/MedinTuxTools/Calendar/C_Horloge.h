...
{        QPainter  p(this);
         ...
         bitBlt ( this,  dx,  dy,  m_pBackPixmap, dx+x(), dy+y(), ur.width(),  ur.height(), Qt::CopyROP , FALSE);               //   Fond
         QRect rect(marge,marge,width()-marge*2,height()-marge*2);
         p.setFont (font());
         //p.drawRect (rect );
         int align(alignment()|Qt::WordBreak|Qt::ExpandTabs);     // Qt::AlignJustify,  -1, 0, QTextParag ** internal = 0 Qt::AlignJustify
...
{       QPainter paint( this );
        ...
        bitBlt ( this,  dx,         dy,         m_pBackPixmap, dx+x(), dy+y(), ur.width(),  ur.height(), Qt::CopyROP , FALSE); //   Fond
        bitBlt ( this,  dx+deltaX,  dy+deltay, &m_Pixmap,      dx,     dy,     ur.width(),  ur.height(), Qt::CopyROP , FALSE); //   image
}
