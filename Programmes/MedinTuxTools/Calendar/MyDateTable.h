...
//=========================================== MyDateTable ================================================
 class  MyDateTable : public QGridView
 {
     Q_OBJECT
 ...
 public:
     MyDateTable(QWidget *parent=0, QDate date=QDate::currentDate(), const char* name=0, WFlags f=0);
     MyDateTable(QWidget *parent, const char* name, WFlags f=0);
     ~MyDateTable();
