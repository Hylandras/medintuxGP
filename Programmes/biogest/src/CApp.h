...
public:
     ...
     */
    QStringList getProfilsList(const QString &varToFind, const QString &section  = "biogest session" );
    ...
    */
    ...
    bool connectDb();
    //------------------------------------ getDB -------------------------------
    /*! \brief retourne une instance du gestionnaire de base de donnée
     *  \return pointer on C_BaseBioGest class
     */
     C_BaseBioGest* getDB();
    //------------------------------------ u_Html -------------------------------
    ...
    //------------------------------------ getTemplate -------------------------------
      ...
      *  \return pointer on C_BaseBioGest class
      */
     QString getPathTemplates();
     //------------------------------------ setTemplate -------------------------------
     /*! \brief positionne lechemin du template en cours pour presentation des données sur la valeur donnee en entree
      *  \param const QString &templat valeur que prendra le chemin du template en cours
      */
     void setPathTemplate(const QString &pathTemplat);
...
private:
    ...
    C_BaseBioGest *m_pC_BaseBioGest;
