...
{//................... Theme ............................................
 QGridLayout* Dlg_CalendarLayout = new QGridLayout( this, 1, 1, 2, 2, "Dlg_CalendarLayout");
 if (Theme::getPath() != "")
...
{pushButtonMenu->setIconSet ( QIcon (rQPixmap)  );
}
//---------------------------------------- Month_setIcon ---------------------------------------
void Dlg_Calendar::Month_setIcon(const QPixmap &moinsQPixmap, const QPixmap &plusQPixmap)
{pushButtonMonthMoins->setIconSet ( QIcon (moinsQPixmap) );
 pushButtonMonthPlus->setIconSet  ( QIcon (plusQPixmap)  );
}
//---------------------------------------- Year_setIcon ---------------------------------------
void Dlg_Calendar::Year_setIcon(const QPixmap &moinsQPixmap, const QPixmap &plusQPixmap)
{pushButtonYearMoins->setIconSet ( QIcon (moinsQPixmap) );
 pushButtonYearPlus->setIconSet  ( QIcon (plusQPixmap)  );
}
...
{   m_CurrentPopupItem = "";
    ...
    {if ( (*(it)).left(4)=="----") m_pQPopupMenu->insertSeparator ();
     else                          m_pQPopupMenu->insertItem( *(it),    this, SLOT( GetPopupItem()),  Qt::CTRL+Qt::Key_L );
    }
    //................. connecter le menu .................................................................
