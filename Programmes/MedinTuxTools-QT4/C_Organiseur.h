 ...
 */
     ...
     */
     QString              Append_Doc_In_Hierarchie(CRubRecord* PCRubRecord, QString hierarch);
...
protected:
    ...
    OpClProfiles     m_OpenCloseProfiles;      /*!< stocke une paire : Nom d'un classeur, données XML de ce classeur  */
