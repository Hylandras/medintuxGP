 ...
 scriptStr.replace("{{masterSrcN user}}",   login_masterSrc);
 scriptStr.replace("{{masterSrcR user}}",   login_masterSrc);
 ...
 scriptStr.replace("{{masterSrcN host}}",   host_masterSrc);
 scriptStr.replace("{{masterSrcN host}}",   host_masterSrc);
 ...
 scriptStr.replace("{{masterSrcN pass}}",   pass_masterSrc);
 scriptStr.replace("{{masterSrcR pass}}",   pass_masterSrc);
 ...
 scriptStr.replace("{{masterSrcN port}}",   port_masterSrc);
 scriptStr.replace("{{masterSrcR port}}",   port_masterSrc);
 ...
 scriptStr.replace("{{masterSrcR logbin}}",   logBin_masterSrc);
 scriptStr.replace("{{masterSrcN logbin}}",   logBin_masterSrc);
 ...
 scriptStr.replace("{{masterSrcR log_Pos}}",   log_Pos_MasterSrc);
 scriptStr.replace("{{masterSrcN log_Pos}}",   log_Pos_MasterSrc);
