...
# ---------- parametres projet pour QT5 ----------
# ....... Etape personnalisee : ....................
# Commande              : cd
# Arguments             : %{buildDir}/../../set_bases/bin
# Repertoire de travail : %{buildDir}

# ....... Etape personnalisee : ....................
# Commande              : %{buildDir}/../../set_bases/bin/MakeAllMac.sh
# Arguments             : %{CurrentProject:Name} %{buildDir}/../../Qt MAKE_ONLY DEBUG
# Repertoire de travail : %{buildDir}

# ....... Executer : ....................
# Executable            : %{buildDir}/../bin/drtux.app/Contents/MacOS/drtux
# Arguments             : 'admin' 'admin' '30DC82DD-7632-2C46-9DC3-BC1AC0ECD20A' '1' 'TARTEMPION' 'MARCEL' '%{buildDir}/../../IndirectConfig/MacAdr/DEBUG_MAC/Manager.ini' '%{buildDir}/../bin/DataBase.cfg'
# Repertoire de travail : %{buildDir}/../bin
#
LANGUAGE = C++
INCLUDEPATH += ../src
MOC_DIR = moc
