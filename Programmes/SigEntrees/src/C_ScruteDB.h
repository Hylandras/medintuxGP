 ...
 *  - this Class needs to know C_Dlg_SigEntrees *pC_Dlg_SigEntrees where are the main dialog class (needs for somes dates and anothers contexts data).
...
class C_ScruteDB : public QObject
{
    Q_OBJECT
public:
    explicit C_ScruteDB(C_Dlg_SigEntrees *pC_Dlg_SigEntrees, QObject *parent = 0);
    ~C_ScruteDB();
...
private:
    ...
    C_Dlg_SigEntrees          *m_pC_Dlg_SigEntrees;
