#ifndef C_Dlg_SigEntrees_H
#define C_Dlg_SigEntrees_H
...
#include "ui/ui_C_Dlg_SigEntrees.h"
...
//==================================  C_Dlg_SigEntrees ============================================================
class C_Dlg_SigEntrees : public QMainWindow
{
    Q_OBJECT

public:
    explicit C_Dlg_SigEntrees(QWidget *parent = 0);
    ~C_Dlg_SigEntrees();
...
private:
     void               getFicHprimResultsFromPatientPk(QString PKentree);
